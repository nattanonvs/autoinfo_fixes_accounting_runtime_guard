...
---------
**Version 1.42**
    - Fix form Customer Invoice Preprint (autoinfo) งานบริการ,งานขาย,Tax Receipt Form (autoinfo) (task A21B-T350)

**Version 1.41**
    - Fix Tax Receipt Form (autoinfo) (task: A21B-T325)
    
**Version 1.40**
    - Fix form Customer Invoice Preprint (autoinfo) งานบริการ(task: A21B-T317)
    - Fix form Customer Invoice Preprint (autoinfo) งานขาย (task: A21B-T317)

**Version 1.39**
    - Fix form Customer Invoice Preprint (autoinfo) งานบริการ(task: A21B-T314)
    
**Version 1.38-1.38d**
    - Fix form Customer Invoice (autoinfo) (task: A21B-T309)
    - Fix form Customer Invoice Preprint (autoinfo) งานขาย (task: A21B-T310)
    - Fix form Customer Invoice Preprint (autoinfo) งานบริการ (task: A21B-T310)
    - Fix form Customer Invoice Preprint (autoinfo) งานขาย (task: A21B-T312)
    
**Version 1.37**
    - Fix task A21B-T300 (Customer invoice Preprint (autoinfo) งานขาย)

**Version 1.36**
    - Add page number in tax receipt report

**Version 1.35**
    - Fixed layout invoice preprint sale report

**Version 1.34-1.34f**
    - Fix task A21B-T293, A21B-T294, A21B-T298
    - Fix task A21B-T293 #2
    - Fix task A21B-T294 #2
