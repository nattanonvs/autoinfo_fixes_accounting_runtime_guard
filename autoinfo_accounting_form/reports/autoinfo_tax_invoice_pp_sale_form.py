...
class autoinfo_tax_invoice_pp_sale_form(models.TransientModel):
    _name = 'autoinfo.tax.invoice.pp.sale.form'
    _description = 'Autoinfo Tax Invoice Preprint Form (Sale)'
    ...
    def show_report(self, report_name=False):
        ...
        email_subject = 'Customer Invoices Form (Autoinfo) งานขาย'
        ...
        self.env.cr.commit()
        return super(autoinfo_tax_invoice_pp_sale_form, self).show_report(email_subject=email_subject,
